...
class Student{ 
	 ...
	 *       ====                     ==== 기능(메소드)setter:setXXX()
	 *       기능(메소드) : getter: getXXX()  
	 */
...
public class MainClass2Check {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		//학생 5명 저장 => 5명을 저장할 수 있는 저장공간(컬렉션(가변),배열(고정))
		...
		for(int i=0; i<list.size(); i++) {
			...
			System.out.printf("%-3d%-6s%-5d%-5d%-5d\n",
					std.getHakbun(),std.getName(),std.getKor(),
					std.getEng(),std.getMath());
		}
		/*//추가 => 가변(원하는 만큼 저장이 가능하다)
		System.out.println("========학생별로 입력========");
